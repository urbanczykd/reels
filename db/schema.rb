...
ActiveRecord::Schema[7.2].define(version: 2026_04_11_101933) do
  ...
  create_table "clips", force: :cascade do |t|
    ...
    t.bigint "soundtrack_id"
    t.integer "generation_progress", default: 0, null: false
    t.index ["soundtrack_id"], name: "index_clips_on_soundtrack_id"
  ...
  add_foreign_key "clips", "soundtracks"
